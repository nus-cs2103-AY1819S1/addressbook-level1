...
public class AddressBook {
     ...
     * Keyword matching is case insensitive as everything will be converted to lower case.
     *
     * @param commandArgs full command args string from the user
     * @return feedback display message for the operation result
     */
     ...
     * @return list of persons in full model with name containing some of the keywords. Case insensitive as
     *          the names will be converted to lower case.
     */
     ...
     *
     * @param rawArgs raw command args string for person command
